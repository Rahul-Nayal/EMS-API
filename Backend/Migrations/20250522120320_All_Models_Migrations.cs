...
{
    /// <inheritdoc />
    public partial class All_Models_Migrations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssetImageUrl = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProjectImageUrl = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assets_AssetTypes_AssetId",
                        column: x => x.AssetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    InTime = table.Column<TimeSpan>(type: "time(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactDetails", x => x.EmployeeId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CGPA = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gender = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProfileImageUrl = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyDetails", x => x.EmployeeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossPay = table.Column<long>(type: "bigint", nullable: false),
                    Deduction = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    BasicPay = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FamilyDetailId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FamilyMemberDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FamilyMemberDetails_FamilyDetails_FamilyDetailId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1d8c4ef2-7b23-4b92-a7e2-178bfe7ecf63", "1d8c4ef2-7b23-4b92-a7e2-178bfe7ecf63", "Admin", "Admin" },
                    { "7f99b3c4-6cf1-44b7-b62b-e7411b52a89d", "7f99b3c4-6cf1-44b7-b62b-e7411b52a89d", "Employee", "Employee" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetTypes_AssetImageUrl",
                table: "AssetTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_ProfileImageUrl",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FamilyMemberDetails_FamilyDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ProjectImageUrl",
                table: "Projects",
